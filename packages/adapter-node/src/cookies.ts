...
/** Raw Node http has no cookie serialization built in, so Set-Cookie strings
 * are built by hand here (RFC 6265's Max-Age is in seconds, matching core's
 * CookieOptions unit — no conversion needed). */
