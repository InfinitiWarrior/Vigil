...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@vigil/adapter-koa": pkg("./packages/adapter-koa/src/index.ts"),
      "@vigil/adapter-node": pkg("./packages/adapter-node/src/index.ts"),
      "@vigil/adapter-bun": pkg("./packages/adapter-bun/src/index.ts"),
      "@vigil/adapter-cloudflare": pkg("./packages/adapter-cloudflare/src/index.ts"),
      "@vigil/adapter-nextjs": pkg("./packages/adapter-nextjs/src/index.ts"),
